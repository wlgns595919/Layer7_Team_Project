...
void itemrespawn(); // 아이템을 일정시간마다 생성해주는함수
void map_reset(); // 혹시라도 맵출력이 이상하게 될경우 맵을 초기화 시켜주는 함수
void intro(); // 시작화면 출력하는 함수
void help(); // 도움말 출력하는 함수
...
int main() {
	...
	while (p1 != 0 && p2 != 0) {
		...
		dissave1 = clock() - gundis1_st; // 지금시간에 총알을 발사했을때 시간을 뺴서 발사한 후의 시간을 구한다
		dissave2 = clock() - gundis2_st;
		bulletload(dissave1, dissave2);

		itemrespawn(); // 아이템 생성함수 실행
...
void intro() {            //시작화면
	...
	printf("\n    / // // ///__|/    8//|               ◎      BUSH & WALL =  ■   ◎          / // // ///__|/    8//|");
	printf("\n   /.(_)// /// |       8///|              ◎                          ◎         /.(_)// /// |       8///|");
	printf("\n  (_)' `(_)//| |       8////|___________  ◎◎◎◎◎◎◎◎◎◎◎◎◎◎◎        (_)' `(_)//| |       8////|___________");
	printf("\n (_) /_\  (_)'| |        8///////////////                                       (_) /_\  (_)'| |        8///////////////");
	printf("\n (_) \"/  (_)'|_|         8/////////////                                        (_) \"/  (_)'|_|         8/////////////");
	printf("\n  (_)._.(_) d' Hb         8oooooooopb'                                          (_)._.(_) d' Hb         8oooooooopb'");
	printf("\n    `(_)'  d'  H`b                                                                `(_)'  d'  H`b");
	printf("\n          d'   `b`b                                                                     d'   `b`b");
	printf("\n         d'     H `b                                                                   d'     H `b");
	printf("\n        d'      `b `b                                                                 d'      `b `b");
...
void help() { //도움말
	system("cls");
	printf("\n\n\n");
	printf("                                    !! 자, 이것은 박스헤드가 아닌 빡쓰헤뜨 !!\n\n");
	printf("                               2인용 총게임인 BOX HEAD를 C언어로 구현해 보았어요\n\n");
	printf("                                      사용 방법은 아주 아주 아주 간단해요\n\n\n");
	printf("                               1P는  W A S D로 움직여요 G키로 총을 쏠 수 있어요\n\n");
	printf("                              2P는  ↑ ← ↓ →로 움직여요 +키로 총을 쏠 수 있어요\n\n");
	printf("                               맵을 다시 생성 (초기화) 하고 싶다면 Y키를 누르세요\n\n");
	printf("                                      15초마다 물약 1개와 총 2개가 스폰되요\n\n");
	printf("                                       총을 쏠려면 반드시 총을 먹어야 해요 \n\n");
	printf("                                그리고 15초가 지나면 총이 사라져 다시 먹어야 해요\n\n");
	printf("                               물약을 먹으면 해당 플레이어의 생명력이 1 증가해요\n\n");
	printf("                                  풀숲에서 총을 쏘면 총알 속도가 조금 상승해요\n\n");
	printf("                         벽과 풀숲은 색으로 구분해요 벽이 하얀색, 풀숲은 초록색이랍니다\n\n");
	printf("                               상대방의 목숨을 0으로 만들면 ★승리★ 해요 참 쉽죠?\n\n\n");
}
...
void shoot1() {
	int i, j;
	while (p1Bullets != 0 || p2Bullets != 0) { // 양플레이어 총알이 모두 맵에서 사라졌을때 반복문 종료
